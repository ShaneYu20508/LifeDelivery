...
const __VLS_42 = __VLS_asFunctionalComponent(__VLS_41, new __VLS_41({...{ }, label: ("信箱"), type: ("email"), modelValue: ((__VLS_ctx.email.value.value)), errorMessages: ((__VLS_ctx.email.errorMessage.value)), }));
({} as { VTextField: typeof __VLS_41 }).VTextField;
({} as { VTextField: typeof __VLS_41 }).VTextField;
const __VLS_43 = __VLS_42({ ...{ }, label: ("信箱"), type: ("email"), modelValue: ((__VLS_ctx.email.value.value)), errorMessages: ((__VLS_ctx.email.errorMessage.value)), }, ...__VLS_functionalComponentArgsRest(__VLS_42));
({} as (props: __VLS_FunctionalComponentProps<typeof __VLS_41, typeof __VLS_43> & Record<string, unknown>) => void)({ ...{ }, label: ("信箱"), type: ("email"), modelValue: ((__VLS_ctx.email.value.value)), errorMessages: ((__VLS_ctx.email.errorMessage.value)), });
const __VLS_44 = __VLS_pickFunctionalComponentCtx(__VLS_41, __VLS_43)!;
let __VLS_45!: __VLS_NormalizeEmits<typeof __VLS_44.emit>;
}
{
const __VLS_46 = ({} as 'VTextField' extends keyof typeof __VLS_ctx ? { 'VTextField': typeof __VLS_ctx.VTextField }: typeof __VLS_resolvedLocalAndGlobalComponents).VTextField;
const __VLS_47 = __VLS_asFunctionalComponent(__VLS_46, new __VLS_46({...{ }, label: ("密碼"), minlength: ("4"), maxlength: ("20"), counter: (true), type: ("password"), modelValue: ((__VLS_ctx.password.value.value)), errorMessages: ((__VLS_ctx.password.errorMessage.value)), }));
({} as { VTextField: typeof __VLS_46 }).VTextField;
({} as { VTextField: typeof __VLS_46 }).VTextField;
const __VLS_48 = __VLS_47({ ...{ }, label: ("密碼"), minlength: ("4"), maxlength: ("20"), counter: (true), type: ("password"), modelValue: ((__VLS_ctx.password.value.value)), errorMessages: ((__VLS_ctx.password.errorMessage.value)), }, ...__VLS_functionalComponentArgsRest(__VLS_47));
({} as (props: __VLS_FunctionalComponentProps<typeof __VLS_46, typeof __VLS_48> & Record<string, unknown>) => void)({ ...{ }, label: ("密碼"), minlength: ("4"), maxlength: ("20"), counter: (true), type: ("password"), modelValue: ((__VLS_ctx.password.value.value)), errorMessages: ((__VLS_ctx.password.errorMessage.value)), });
const __VLS_49 = __VLS_pickFunctionalComponentCtx(__VLS_46, __VLS_48)!;
let __VLS_50!: __VLS_NormalizeEmits<typeof __VLS_49.emit>;
}
{
const __VLS_51 = ({} as 'VTextField' extends keyof typeof __VLS_ctx ? { 'VTextField': typeof __VLS_ctx.VTextField }: typeof __VLS_resolvedLocalAndGlobalComponents).VTextField;
const __VLS_52 = __VLS_asFunctionalComponent(__VLS_51, new __VLS_51({...{ }, label: ("確認密碼"), minlength: ("4"), maxlength: ("20"), counter: (true), type: ("password"), modelValue: ((__VLS_ctx.passwordConfirm.value.value)), errorMessages: ((__VLS_ctx.passwordConfirm.errorMessage.value)), }));
({} as { VTextField: typeof __VLS_51 }).VTextField;
({} as { VTextField: typeof __VLS_51 }).VTextField;
const __VLS_53 = __VLS_52({ ...{ }, label: ("確認密碼"), minlength: ("4"), maxlength: ("20"), counter: (true), type: ("password"), modelValue: ((__VLS_ctx.passwordConfirm.value.value)), errorMessages: ((__VLS_ctx.passwordConfirm.errorMessage.value)), }, ...__VLS_functionalComponentArgsRest(__VLS_52));
({} as (props: __VLS_FunctionalComponentProps<typeof __VLS_51, typeof __VLS_53> & Record<string, unknown>) => void)({ ...{ }, label: ("確認密碼"), minlength: ("4"), maxlength: ("20"), counter: (true), type: ("password"), modelValue: ((__VLS_ctx.passwordConfirm.value.value)), errorMessages: ((__VLS_ctx.passwordConfirm.errorMessage.value)), });
const __VLS_54 = __VLS_pickFunctionalComponentCtx(__VLS_51, __VLS_53)!;
let __VLS_55!: __VLS_NormalizeEmits<typeof __VLS_54.emit>;
}
{
const __VLS_56 = ({} as 'VBtn' extends keyof typeof __VLS_ctx ? { 'VBtn': typeof __VLS_ctx.VBtn }: typeof __VLS_resolvedLocalAndGlobalComponents).VBtn;
const __VLS_57 = __VLS_asFunctionalComponent(__VLS_56, new __VLS_56({...{ }, type: ("submit"), color: ("green"), }));
({} as { VBtn: typeof __VLS_56 }).VBtn;
({} as { VBtn: typeof __VLS_56 }).VBtn;
const __VLS_58 = __VLS_57({ ...{ }, type: ("submit"), color: ("green"), }, ...__VLS_functionalComponentArgsRest(__VLS_57));
({} as (props: __VLS_FunctionalComponentProps<typeof __VLS_56, typeof __VLS_58> & Record<string, unknown>) => void)({ ...{ }, type: ("submit"), color: ("green"), });
